...
/// The New Advisor Dashboard - Liquid Glass Dark Theme Architecture
///
/// This is the main container for the advisor experience, featuring:
/// - A modern floating glassmorphic navigation bar (matching Student Dashboard)
/// - Four distinct, fully functional screens
/// - Perfect backend integration with live data
/// - SafeArea compliance (no status bar issues)
/// - Clean, professional interface for request management
              ...
              child: BottomNavigationBar(
                ...
                items: [
                  BottomNavigationBarItem(
                    icon: Icon(Icons.pending_actions_rounded, size: 6.w),
                    activeIcon: Container(
                      ...
                      child: Icon(Icons.pending_actions_rounded, size: 6.w),
                    ),
                    label: 'Requests',
                  ),
                  BottomNavigationBarItem(
                  ...
                  BottomNavigationBarItem(
                    icon: Icon(Icons.history_rounded, size: 6.w),
                    activeIcon: Container(
                      padding: EdgeInsets.all(2.w),
                      decoration: BoxDecoration(
                        color: accentColor.withOpacity(0.2),
                      ...
                      child: Icon(Icons.history_rounded, size: 6.w),
                    ),
                    label: 'History',
                  ),
                  BottomNavigationBarItem(
